...
(function(){
    ...
    function parse($TEXT, options) {
        ...
        function do_import(key) {
            ...
            var package_module_id, filename, src_code, modpath, location, data, msg, contents;
            ...
            if (src_code === null) {
                msg = "Failed Import: '" + key + "' module doesn't exist in any of the import directories: " + import_dirs.join(", ");
                throw new ImportError(msg, options.filename);
            }
